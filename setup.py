...
setup(
    ...
    description='a simple event/interval logging server',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/fHachenberg/pyinterval',

    # Author details
    author='Fabian Hachenberg',
    author_email='fhachenberg@github.com',
    ...
    keywords='logging events intervals work_efficiency',
    ...
    install_requires=['typing', 'setproctitle'],
